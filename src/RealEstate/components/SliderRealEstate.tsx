...
export const SliderRealEstate = () => {
    const [data, _] = useState(STATIC_DATA.REALESTATE)
    return (
        <>
            <div className="relative w-full ">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10  border md:px-8 md:py-14 px-3 py-4 text-center rounded-md backdrop-blur-sm backdrop-brightness-75">
                    <div className="flex flex-col items-center md:space-y-5 space-y-3">
                        <h1 className="md:text-6xl text-xl  text-slate-900  whitespace-nowrap font-bold uppercase tracking-tighter">Best Properties for you</h1>
                        <h4 className="md:text-lg font-medium text-slate-100 leading-tight">"Connecting you with premium properties for a seamless real estate experience."</h4>
